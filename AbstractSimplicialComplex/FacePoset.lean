...
import AbstractSimplicialComplex.GeneralPreorderStuff 
...
/- Partial order instance on the type of faces of an abstract simplicial complex: this is just induced by
the inclusion.-/
...
/- If f is a simplicial map, then its face map is an order homomorphism.-/
...
/- We prove that the face poset if a LocallyFiniteOrder and a LocallyFiniteOrderBot.-/

/- Left-infinite right-closed intervals of the face poset are finite.-/
...
/- Closed intervals of the face poset are finite.-/
...
/-LocallyFiniteOrderBot instance on the face poset.-/
...
/-LocallyFiniteOrder instance on the face poset.-/
...
/- Ideals of the face poset. These are more interesting.-/
